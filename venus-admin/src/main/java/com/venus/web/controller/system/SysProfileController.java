...
import com.venus.common.utils.file.FileUploadUtils;
import com.venus.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(VenusConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
