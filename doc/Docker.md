...
![image-20211101172701005](D:/project/Venus/doc/Docker/image-20211101172701005.png)

2.错误排查

![img](D:/project/Venus/doc/Docker/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3hpbmdlZ2U=,size_16,color_FFFFFF,t_70)
...
四、使用以下命令来运行 mysql 容器：
 ```shell script
  $ docker run -itd --name mysql -p 8083:3306 -e MYSQL_ROOT_PASSWORD=123456 mysql
 ```
...
> MYSQL连接地址使用的是宿主机(docker)的地址，通过ifconfig获取ip地址
